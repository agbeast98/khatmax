...
/**
 * Renders the "Open in Khatmax" titlebar entry as an icon-only button that
...
export class OpenInVSCodeTitleBarWidget extends BaseActionViewItem {
	...
	override render(container: HTMLElement): void {
		...
		const hoverText = this.keybindingService.appendKeybinding(localize('openInVSCodeHover', "Open in Khatmax Editor Window"), this.keybindingCommandId);
