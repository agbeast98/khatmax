 ...
 * - `IN_PRODUCT` - Content shown in Khatmax (both Stable and Insiders)
 * - `WEB` - Content shown on the website only
 * - `STABLE` - Content shown in Khatmax Stable only
 * - `INSIDERS` - Content shown in Khatmax Insiders only
 *
