...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Khatmax in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Khatmax and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
