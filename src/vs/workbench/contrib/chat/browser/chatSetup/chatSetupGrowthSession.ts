...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "try Khatmax AI"),
			description: localize('growthSession.description', "Khatmax AI is available. Try it for free."),
