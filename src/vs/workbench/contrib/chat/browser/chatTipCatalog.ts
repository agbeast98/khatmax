	...
	},
	{
		...
		buildMessage() {
			return new MarkdownString(
				localize(
					'tip.copilotCli',
					"Run agents in parallel with [Khatmax Agent](command:workbench.action.chat.openNewChatSessionInPlace.copilotcli?%5B%22sidebar%22%5D \"Switch to Khatmax Agent\")."
				)
			);
		},
		when: ContextKeyExpr.and(
