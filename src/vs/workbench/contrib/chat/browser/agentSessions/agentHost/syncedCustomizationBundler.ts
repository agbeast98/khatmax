...
const DISPLAY_NAME = 'Khatmax Synced Data';

const MANIFEST_CONTENT = JSON.stringify({
	name: DISPLAY_NAME,
	description: 'Customization data synced from Khatmax',
}, null, '\t');
...
/**
 * An MCP server configured directly in Khatmax (i.e. not contributed by an
 ...
 * ```
 * .plugin/plugin.json
 * .mcp.json        ← MCP servers configured in Khatmax
