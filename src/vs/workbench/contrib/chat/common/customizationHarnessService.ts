 ...
 *
 * The default (core) registration exposes a single "Khatmax" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * Khatmax harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default Khatmax harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
...
/**
 * Creates a "Khatmax" harness descriptor that shows all storage sources
