...
export namespace ChatContextKeys {
	...
	export const newChatButtonExperimentIcon = new RawContextKey<string>('chatNewChatButtonExperimentIcon', '', { type: 'string', description: localize('chatNewChatButtonExperimentIcon', "The icon variant for the new chat button, controlled by experiment. Values: 'Khatmax AI', 'new-session', 'comment', or empty for default.") });
}
