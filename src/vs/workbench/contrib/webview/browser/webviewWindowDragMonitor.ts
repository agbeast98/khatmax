...
/**
 * Allows webviews to monitor when an element in the Khatmax editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Khatmax needs to see this
