...
const enum ShellIntegrationOscPs {
	...
	FinalTerm = 133,
	/**
	 * Sequences pioneered by Khatmax. The number is derived from the least significant digit of
...
/**
 * Khatmax-specific shell integration sequences. Some of these are based on common alternatives like
