 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Khatmax UI).
 */
 ...
 * to represent terminals that appear in other parts of the Khatmax UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Khatmax OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given Khatmax log level.
	 */
	updateLogLevel(): void;
